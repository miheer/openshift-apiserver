...
type IngressControllerHTTPHeaderActions struct {
	...
	// + ---
	// + Note: Any change to regex mentioned below shall be reflected in the crd validation of route in library-go(https://github.com/openshift/library-go/blob/master/pkg/route/validation/validation.go) or vice-versa.
	// +listType=map
	// +listMapKey=name
	// +optional
